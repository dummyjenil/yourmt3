...
from yourmt3.model.conformer_mod import ConformerYMT3Encoder
from yourmt3.model.conformer_helper import ConformerYMT3Config
from yourmt3.model.lm_head import LMHead
from yourmt3.model.pitchshift_layer import PitchShiftLayer
from yourmt3.model.spectrogram import get_spectrogram_layer_from_audio_cfg
from yourmt3.model.conv_block import PreEncoderBlockRes3B
from yourmt3.model.conv_block import PreEncoderBlockHFTT, PreEncoderBlockRes3BHFTT  # added for hFTT-like pre-encoder
from yourmt3.model.projection_layer import get_projection_layer, get_multi_channel_projection_layer
from yourmt3.model.optimizers import get_optimizer
from yourmt3.model.lr_scheduler import get_lr_scheduler

from yourmt3.utils.note_event_dataclasses import Note
from yourmt3.utils.note2event import mix_notes
from yourmt3.utils.event2note import merge_zipped_note_events_and_ties_to_notes, DECODING_ERR_TYPES
from yourmt3.utils.metrics import compute_track_metrics
from yourmt3.utils.metrics import AMTMetrics
# from yourmt3.utils.utils import write_model_output_as_npy
from yourmt3.utils.utils import write_model_output_as_midi, create_inverse_vocab, write_err_cnt_as_json
from yourmt3.utils.utils import Timer
from yourmt3.utils.task_manager import TaskManager

from yourmt3.config.config import audio_cfg as default_audio_cfg
from yourmt3.config.config import model_cfg as default_model_cfg
from yourmt3.config.config import shared_cfg as default_shared_cfg
from yourmt3.config.config import T5_BASE_CFG
...
class YourMT3(pl.LightningModule):
    ...
    def __init__(
        ...
        if write_output_dir is not None:
            if write_output_vocab is None:
                from yourmt3.config.vocabulary import program_vocab_presets
    ...
    def inference_file(
        ...
        for i in range(0, n_items, bsz):
            if callback:callback(i,n_items)
