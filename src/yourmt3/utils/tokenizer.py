...
from yourmt3.utils.note_event_dataclasses import Event, EventRange, Note  #, Codec
from yourmt3.utils.event_codec import FastCodec as Codec
from yourmt3.utils.note_event_dataclasses import NoteEvent
